...
save(['dataSet' num2str(dataSet) '_networkMeasures_Pearson.mat'],'networkMeasures');
networkMeasures_Table = array2table(networkMeasures,'VariableNames',variableNames);
if print == 1
    writetable(networkMeasures_Table,['dataSet' num2str(dataSet) '_networkMeasures_Pearson.xlsx']);
end
...
save(['dataSet' num2str(dataSet) '_networkMeasures_Pearson_normalized.mat'],'fracRankNorm');
fracRankNorm_Table = array2table(fracRankNorm,'VariableNames',variableNames);
if print == 1
    writetable(fracRankNorm_Table,['dataSet' num2str(dataSet) '_networkMeasures_Pearson_normalized.xlsx']);
end