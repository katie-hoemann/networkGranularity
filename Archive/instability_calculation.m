% This script calculates emotional instability for all subjects in the specified data set
...
filename = ['dataSet' num2str(dataSet) '_instability.mat'];
save(filename,'instability');