...
for i_subject = 1:length(subjectIDlist)
    ...
    for i_window = 1:length(dayIDlist)-2
        ...
        clearvars communityAssignment_Iter modularity_Iter communityAssignment
    end
...
save(['dataSet' num2str(dataSet) '_networkMeasureMeans_Pearson_windows.mat'],'networkMeasureMeans');
save(['dataSet' num2str(dataSet) '_networkMeasureSDs_Pearson_windows.mat'],'networkMeasureSDs');
...
if printSummaries == 1
    writetable(networkMeasureMeans_Table,['dataSet' num2str(dataSet) '_networkMeasureMeans_Pearson_windows.xlsx']);
    writetable(networkMeasureSDs_Table,['dataSet' num2str(dataSet) '_networkMeasureSDs_Pearson_windows.xlsx']);
end
...
save(['dataSet' num2str(dataSet) '_networkMeasureMeans_Pearson_windows_normalized.mat'],'fracRankNorm_Means');
save(['dataSet' num2str(dataSet) '_networkMeasureSDs_Pearson_windows_normalized.mat'],'fracRankNorm_SDs');
...
if printSummaries == 1
    writetable(fracRankNorm_Means_Table,['dataSet' num2str(dataSet) '_networkMeasureMeans_Pearson_windows_normalized.xlsx']);
    writetable(fracRankNorm_SDs_Table,['dataSet' num2str(dataSet) '_networkMeasureSDs_Pearson_windows_normalized.xlsx']);
end
